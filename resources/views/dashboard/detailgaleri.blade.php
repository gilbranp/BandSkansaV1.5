...
<div class="row">
    <div class="col-md-4">
        <img src="/images/imggaleri/{{ $pengelolaan->img }}" class="img-fluid  mt-4" style="width: 440px; height: 440px"
            alt="Foto Konten">
    </div>
    <div class="col-md-8 mt-1">
        ...
        <div class="form-group">
            ...
            <input type="text" name="namaacara" class="form-control" value="{{ $pengelolaan->namaacara }}" readonly
                disabled>
        </div>
        <div class="form-group">
            <label>Tempat</label>
        ...
        <div class="form-group">
            ...
            <input type="date" name="tanggal" class="form-control" value="{{ $pengelolaan->tanggal }}" readonly
                disabled>
        </div>
        {{-- <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" name="created_at" class="form-control" placeholder="Dibuat Pada"
            value="{{ $pengelolaan->created_at }}" readonly disabled>
    </div>
    <div class="form-group">
        <label>Diupdate pada</label>
        <input type="text" name="updated_at" class="form-control" placeholder="Di Update Pada"
            value="{{ $pengelolaan->updated_at }}" readonly disabled>
    </div>

</div>
</div>

<a href="/admin-pengelolaankonten">
