                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="{{ route('admin-pengelolaankonten.store') }}" method="POST"
                                ...
                                <div class="form-group">
                                    <label>Url</label>
                                    <input type="url" name="url" class="form-control" placeholder="Masukkan URL"
                                        required>
                                </div>
                                <div class="form-group">
                                    <label>Detail</label>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="align-middle">
                        <a href="{{ route('admin-pengelolaankonten.show', $pengelolaan->id) }}"
                            class="btn btn-success">DETAIL</a>
                        <a href="{{ route('admin-pengelolaankonten.edit', $pengelolaan->id) }}"
                            class="btn btn-warning">EDIT</a>
                        <form action="{{ route('admin-pengelolaankonten.destroy', $pengelolaan->id) }}" method="POST"
