                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="{{ route('admin-blogpengelolaan.store') }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tag" class="form-control"
                                        placeholder="Contoh : #BandSkansa" required>
                                </div>
                                <div class="form-group">
                                    <label>Tanggal</label>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="align-middle">
                                <a href="{{ route('admin-blogpengelolaan.show',$blogpengelola->id) }}"
                                    class="btn btn-success">DETAIL</a>
                                <a href="" class="btn btn-warning">EDIT</a>
                                <form action="{{ route('admin-blogpengelolaan.destroy',$blogpengelola->id) }}"
