...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  ...
  <form action="{{ route('admin-pengelolaankonten.update', $pengelolaankonten->id) }}" method="POST">
    ...
    <div class="row">
      ...
      <div class="col-11">
    <input type="text" name="judul" class="form-control" required placeholder="Masukkan Nama Judul" value="{{ $pengelolaankonten->judul }}">
  </div>
    </div>
    <div class="row mt-1">
      <label for="inputEmail3" class="col-1 col-form-label">Acara</label>
      <div class="col-11">
    <input type="text" name="namaacara" class="form-control" required placeholder="Masukkan Nama Acara" value="{{ $pengelolaankonten->namaacara }}">
  </div>
    </div>
  ...
  <div class="row mt-1">
    ...
    <div class="col-11">
    <input type="text" name="url" class="form-control" required placeholder="Contoh : https://www.urlmu.com" value="{{ $pengelolaankonten->url }}">
</div>
  </div>
  ...
  <div class="row mt-1">
    ...
    <div class="col-11">
    <textarea type="text" name="detail" class="form-control" required placeholder="Masukkan Detail" >{{ $pengelolaankonten->detail }} </textarea>
  </div>
  </div>
...
{{-- 
  ...
  <div class="modal-footer mt-5">
    <a href="/admin-pengelolaankonten"><button type="button" class="btn btn-secondary btn-separator">Batal</button></a>
