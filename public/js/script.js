  ...
  const calendar = new FullCalendar.Calendar(calendarEl, {
    customButtons: {
      customButton: {
        ...
        click: function () {
          ...
          modalTitle.innerHTML = 'Tambahkan Jadwal'
          submitButton.innerHTML = 'Tambahkan Jadwal'
    ...
    eventRender: function(info) {
      info.el.addEventListener('contextmenu', function(e) {
        ...
        <li><i class="fas fa-trash-alt"></i>Hapus</li>
        </ul>`;
        ...
        menu.querySelector('li:first-child').addEventListener('click', function() {
          ...
          modalTitle.innerHTML = 'Edit Jadwal';
          ...
          submitButton.innerHTML = 'Simpan dan Ganti';
        ...
        menu.querySelector('li:last-child').addEventListener('click', function() {
          ...
          modalBody.innerHTML = `Apakah kamu yakin akan menghapus <b>"${info.event.title}"</b>?`
          deleteModal.show();
